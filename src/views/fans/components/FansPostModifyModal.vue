<template>
  <a-modal :confirmLoading="okLoading" :maskClosable="false" :title="title" :width="width" :visible="visible" @ok="handleOk" :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <FansPostModifyForm ref="registerForm"  @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></FansPostModifyForm>
  </a-modal>
</template>
...
import { ref, nextTick, defineExpose } from 'vue';
  import FansPostModifyForm from './FansPostModifyForm.vue'
